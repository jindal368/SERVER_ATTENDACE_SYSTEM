...
export const verifyEmail=(req,res)=>{
  ...
  if(req.tokenPayload.reason===globalConstants.VERIFY_EMAIL){
    StudentModal.findByIdAndUpdate(req.tokenPayload.id,{$set:{isVerified:true}},{new:true})
    .then((resp)=>{
...
export const forgotPasswordChangePassword=(req,res)=>{
  ...
  if(payload.reason === globalConstants.FORGOT_PASSWORD){
      ...
      .then((hashedPass)=>{
          return StudentModal.findByIdAndUpdate(payload.id,{$set:{password:hashedPass}},{new:true})
      })
      .then(()=>{
